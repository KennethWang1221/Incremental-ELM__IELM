...
% Elm_Type              - 0 for regres   sion; 1 for (both binary and multi-classes) classification
...
for i=1:NumberofHiddenNeurons
   InputWeight(i,:)=rand(1,NumberofInputNeurons)*2-1;
   BiasofHiddenNeurons(i,:)=rand(1,NumberofTrainingData);
...
Y=(H' * beita)';                             %   Y: the actual output of the training data
if Elm_Type == REGRESSION
...
TY=(H_test' * beita)';                       %   TY: the actual output of the testing data
